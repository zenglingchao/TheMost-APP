...
/**
 * Created by Ziyu on 2016/9/19.11:16
 *
 * 硬盘缓存
 */
public class DiskLruCacheUtil {
    ...
    public static boolean setCache(String url, Bitmap bitmap){
        Log.d("print", "setCache: "+ url);
        if(url != null && bitmap != null && getCache(url) == null){
            Log.d("print", "setCache: "  + bitmap);
    ...
    /**
     * 获得磁盘缓存的路径
     * /storage/emulated/0/Android/data/com.example.ziyu.themostdemo/cache/bitmap
     * @return
     */
