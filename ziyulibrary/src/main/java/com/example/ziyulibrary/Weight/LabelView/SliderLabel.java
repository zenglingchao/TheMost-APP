package com.example.ziyulibrary.Weight.LabelView;
 ...
 * 侧边控件和标签控件的组合控件
 */
public class SliderLabel extends FrameLayout implements SlidBarView.OnTouchSlidBarListener {
    ...
    public SliderLabel(Context context) {
        this(context, null);
    }

    public SliderLabel(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SliderLabel(Context context, AttributeSet attrs, int defStyleAttr) {
